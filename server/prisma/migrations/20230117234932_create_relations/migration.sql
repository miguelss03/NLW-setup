...
CREATE TABLE "new_habits_week_days" (
    ...
    CONSTRAINT "habits_week_days_habits_id_fkey" FOREIGN KEY ("habits_id") REFERENCES "habits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_habits_week_days" ("habits_id", "id", "week_days") SELECT "habits_id", "id", "week_days" FROM "habits_week_days";
DROP TABLE "habits_week_days";
ALTER TABLE "new_habits_week_days" RENAME TO "habits_week_days";
CREATE UNIQUE INDEX "habits_week_days_habits_id_week_days_key" ON "habits_week_days"("habits_id", "week_days");
